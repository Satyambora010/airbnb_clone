...
const Header = () => {
  ...
  return (
    <header className="flex justify-between">
      ...
      <div className='flex gap-2 border border-gray-300 rounded-full p-3 shadow-md shadow-gray-300'> 
        <div>Anywhere</div>
      ...
      <Link to={user?'/account':'/login'} className="flex gap-2 items-center border border-gray-300 rounded-full p-3">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6 relative">
